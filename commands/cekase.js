...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cekase')
        .setDescription('Nastavit stav nápadu na "Čeká se"')
    ...
    async execute(interaction) {
        ...
        const result = await updateIdeaStatus(channel, messageId, 'cekase', interaction.user);

        if (result) {
            await interaction.reply({ content: `🕐 Nápad **${messageId}** nastaven na "Čeká se"!`, ephemeral: true });
        } else {
